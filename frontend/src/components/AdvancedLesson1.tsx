...
const questions = [
  {
    question: "What is the English translation of 'Éphémère'?",
    options: ["Ephemeral", "Permanent", "Strong", "Difficult"],
    correctIndex: 0,
  },
  {
    question: "How do you say 'Soutenir' in English?",
    options: ["Support", "Destroy", "Accept", "Reject"],
    correctIndex: 0,
  },
  {
    question: "Translate 'Démêler' into English:",
    options: ["Untangle", "Tangle", "Tie", "Cut"],
    correctIndex: 0,
  },
  {
    question: "What does 'Frondeur' mean in English?",
    options: ["Rebel", "Follower", "Leader", "Supporter"],
    correctIndex: 0,
  },
  {
    question: "How do you say 'Habile' in English?",
    options: ["Skillful", "Clumsy", "Slow", "Loud"],
    correctIndex: 0,
  },
  {
    question: "Translate 'Indolent' into English:",
    options: ["Lazy", "Active", "Strong", "Happy"],
    correctIndex: 0,
  },
  {
    question: "What is the English word for 'Jovial'?",
    options: ["Cheerful", "Sad", "Angry", "Shy"],
    correctIndex: 0,
  },
  {
    question: "How do you say 'Laconique' in English?",
    options: ["Concise", "Talkative", "Loud", "Slow"],
    correctIndex: 0,
  },
  {
    question: "Translate 'Misanthrope' into English:",
    options: ["Misanthrope", "Philanthropist", "Optimist", "Pessimist"],
    correctIndex: 0,
  },
  {
    question: "What is the English equivalent of 'Néophyte'?",
    options: ["Beginner", "Expert", "Teacher", "Leader"],
    correctIndex: 0,
  },
  {
    question: "How do you say 'Ostracisme' in English?",
    options: ["Ostracism", "Praise", "Invitation", "Unity"],
    correctIndex: 0,
  },
  {
    question: "Translate 'Pugnace' into English:",
    options: ["Combative", "Peaceful", "Lazy", "Calm"],
    correctIndex: 0,
  },
  {
    question: "What does 'Quotidien' mean in English?",
    options: ["Daily", "Rare", "Annual", "Occasional"],
    correctIndex: 0,
  },
  {
    question: "How do you say 'Récalcitrant' in English?",
    options: ["Recalcitrant", "Obedient", "Gentle", "Friendly"],
    correctIndex: 0,
  },
  {
    question: "Translate 'Sérendipité' into English:",
    options: ["Serendipity", "Misfortune", "Failure", "Chance"],
    correctIndex: 0,
  },
];

const AdvancedLesson1: React.FC = () => {
...
export default AdvancedLesson1;
