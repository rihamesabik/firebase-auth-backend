...
const BeginnerLesson3: React.FC = () => {
  const questions = [
    {
    ...
    {
      question: "What color does 'Vert' mean in English?",
      options: ["Black", "Pink", "Green", "Brown"],
      correctIndex: 2,
    },
    {
      question: "How do you say 'Bleu' in English?",
      options: ["Blue", "Orange", "Grey", "White"],
      correctIndex: 0,
    },
    {
      question: "What does 'Yellow' mean in French?",
      options: ["Jaune", "Noir", "Violet", "Gris"],
      correctIndex: 0,
    },
    {
      question: "What is the English for 'Noir'?",
      options: ["White", "Black", "Purple", "Green"],
      correctIndex: 1,
    },
    {
      question: "How do you say 'Blanc' in English?",
      options: ["Red", "Grey", "White", "Brown"],
      correctIndex: 2,
    },
    {
      question: "What is the translation of 'Rose'?",
      options: ["Orange", "Purple", "Pink", "Blue"],
      correctIndex: 2,
    },
  ];
  ...
  const handleAnswer = (index: number) => {
    if (answered) return; // empêcher plusieurs clics
    setAnswered(true);
    ...
    <div className="min-h-screen bg-gradient-to-tr from-purple-100 via-purple-50 to-purple-100 flex items-center justify-center p-6">
      <div className="bg-white max-w-lg w-full rounded-3xl shadow-2xl p-10 flex flex-col">
        <h2 className="text-3xl font-extrabold text-purple-700 mb-8 text-center">
          Leçon 3 : Les moyens de transport et les couleurs
        </h2>
...
export default BeginnerLesson3;
