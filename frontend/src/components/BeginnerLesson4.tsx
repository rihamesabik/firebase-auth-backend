...
const BeginnerLesson4: React.FC = () => {
  const questions = [

    {
      question: "How do you say 'Père' in English?",
    ...
    {
      question: "Translate 'Frère' into English:",
      options: ["Sister", "Brother", "Uncle", "Father"],
      correctIndex: 1,
    },
    {
      question: "How do you say 'Sœur' in English?",
      options: ["Mother", "Cousin", "Sister", "Grandmother"],
      correctIndex: 2,
    },
    {
      question: "What is the English for 'Oncle'?",
      options: ["Uncle", "Nephew", "Father", "Brother-in-law"],
      correctIndex: 0,
    },
    {
      question: "Translate 'Tante' into English:",
      options: ["Grandmother", "Mother", "Aunt", "Sister"],
      correctIndex: 2,
    },
    {
      question: "How do you say 'Cousin' in English?",
...
export default BeginnerLesson4;
