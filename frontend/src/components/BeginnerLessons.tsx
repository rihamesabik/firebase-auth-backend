...
const BeginnerLessons: React.FC = () => {
  const navigate = useNavigate();

  const lessons = [
    { id: 1, title: "Leçon 1 : Liste des expressions" },
    { id: 2, title: "Leçon 2 : Les fruits" },
    { id: 3, title: "Leçon 3 : Les couleurs" },
    { id: 4, title: "Leçon 4 : famille" },
    { id: 5, title: "Leçon 5 : les moyens de transport" },
    { id: 6, title: "Leçon 6 : les chiffres" },
    { id: 7, title: "Leçon 7 :  les vêtements" },
  ];

  const lessonPath = (id: number) => `/beginner-lessons/lesson-${id}`;
