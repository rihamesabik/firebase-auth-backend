...
const questions = [
  {
    question: "How do you say 'Où est la bibliothèque ?' in English?",
    options: ["Where is the library?", "How is the library?", "What is the library?", "When is the library?"],
    correctIndex: 0,
  },
  {
    question: "Translate 'Tournez à gauche' into English:",
    options: ["Turn left", "Turn right", "Go straight", "Turn around"],
    correctIndex: 0,
  },
  {
    question: "What is the English for 'Traversez la rue'?",
    options: ["Cross the street", "Walk along the road", "Stay on the sidewalk", "Follow the traffic"],
    correctIndex: 0,
  },
  {
    question: "How do you say 'C’est à côté du supermarché' in English?",
    options: ["It’s next to the supermarket", "It’s under the supermarket", "It’s across the supermarket", "It’s far from the supermarket"],
    correctIndex: 0,
  },
  {
    question: "Translate 'Prenez la première rue à droite' into English:",
    options: ["Take the first street on the right", "Take the second street on the left", "Go straight", "Stop at the light"],
    correctIndex: 0,
  },
  {
    question: "What is the English for 'Le musée est en face de l’école'?",
    options: ["The museum is opposite the school", "The museum is behind the school", "The museum is next to the school", "The museum is inside the school"],
    correctIndex: 0,
  },
  {
    question: "How do you say 'Continuez tout droit' in English?",
    options: ["Go straight ahead", "Go left", "Turn around", "Stop here"],
    correctIndex: 0,
  },
];

const IntermediateLesson3: React.FC = () => {
...
export default IntermediateLesson3;
