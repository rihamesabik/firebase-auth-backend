...
const questions = [
  ...
  {
    question: "Translate 'Infirmier / Infirmière' into English:",
    options: ["Nurse", "Cook", "Waiter", "Mechanic"],
    correctIndex: 0,
  },
  {
    question: "What is the English for 'Enseignant / Enseignante'?",
    options: ["Teacher", "Dentist", "Driver", "Baker"],
    correctIndex: 0,
  },
  {
    question: "How do you say 'Pompier' in English?",
    options: ["Firefighter", "Policeman", "Plumber", "Electrician"],
    correctIndex: 0,
  },
  {
    question: "Translate 'Chauffeur' into English:",
    options: ["Driver", "Pilot", "Cashier", "Singer"],
    correctIndex: 0,
  },
  {
    question: "What is the English for 'Cuisinier / Cuisinière'?",
    options: ["Cook", "Waiter", "Farmer", "Builder"],
    correctIndex: 0,
  },
  {
    question: "How do you say 'Policier' in English?",
    options: ["Police officer", "Judge", "Postman", "Doctor"],
    correctIndex: 0,
  },
];

const IntermediateLesson4: React.FC = () => {
...
export default IntermediateLesson4;
