...
const questions = [
  ...
  {
    question: "What is the English for 'Main'?",
    options: ["Hand", "Leg", "Back", "Ear"],
    correctIndex: 0,
  },
  {
    question: "Translate 'Jambe' into English:",
    options: ["Leg", "Neck", "Arm", "Toe"],
    correctIndex: 0,
  },
  {
    question: "How do you say 'Yeux' in English?",
    options: ["Eyes", "Ears", "Nose", "Lips"],
    correctIndex: 0,
  },
  {
    question: "What is the English for 'Bouche'?",
    options: ["Mouth", "Chin", "Nose", "Eye"],
    correctIndex: 0,
  },
  {
    question: "Translate 'Épaule' into English:",
    options: ["Shoulder", "Finger", "Stomach", "Knee"],
    correctIndex: 0,
  },
  {
    question: "How do you say 'Oreilles' in English?",
    options: ["Ears", "Arms", "Hands", "Feet"],
    correctIndex: 0,
  },
];

const IntermediateLesson5: React.FC = () => {
...
export default IntermediateLesson5;
