...
const questions = [
  {
    question: "How do you say 'Heureux' in English?",
    options: ["Happy", "Angry", "Tired", "Worried"],
    correctIndex: 0,
  },
  {
    question: "What is the English word for 'Triste'?",
    options: ["Sad", "Happy", "Excited", "Relaxed"],
    correctIndex: 0,
  },
  {
    question: "Translate 'En colère' into English:",
    options: ["Angry", "Shy", "Joyful", "Calm"],
    correctIndex: 0,
  },
  {
    question: "How do you say 'Fatigué' in English?",
    options: ["Tired", "Sad", "Excited", "Worried"],
    correctIndex: 0,
  },
  {
    question: "What is the English for 'Effrayé'?",
    options: ["Scared", "Calm", "Happy", "Proud"],
    correctIndex: 0,
  },
  {
    question: "Translate 'Nerveux' into English:",
    options: ["Nervous", "Excited", "Happy", "Angry"],
    correctIndex: 0,
  },
  {
    question: "How do you say 'Fier' in English?",
    options: ["Proud", "Lazy", "Jealous", "Bored"],
    correctIndex: 0,
  },
];

const IntermediateLesson7: React.FC = () => {
...
export default IntermediateLesson7;
