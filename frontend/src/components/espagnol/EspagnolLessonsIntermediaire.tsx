...
const EspagnolLessonsIntermediaire: React.FC = () => {
  const navigate = useNavigate();

  const lessons = [
    { id: 1, title: "Lección 1: Verbos en presente" },
    { id: 2, title: "Lección 2: Tiempos pasados" },
    { id: 3, title: "Lección 3: Pronombres" },
    { id: 4, title: "Lección 4: Preposiciones" },
    { id: 5, title: "Lección 5: Vocabulario avanzado" },
    { id: 6, title: "Lección 6: Comprensión auditiva" },
    { id: 7, title: "Lección 7: Expresiones idiomáticas" },
  ];

  const lessonPath = (id: number) => `/espagnol/intermediaire/lesson-${id}`;
  ...
  return (
    <div className="relative min-h-screen bg-gradient-to-tr from-purple-900 via-purple-700 to-indigo-800 p-8 overflow-hidden text-white flex flex-col items-center">
      ...
      >
        Lecciones para Intermedio - Español
      </motion.h1>
...
export default EspagnolLessonsIntermediaire;
