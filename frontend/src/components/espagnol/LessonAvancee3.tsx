...
const LessonAvancee3: React.FC = () => {
  const questions = [
    {
      question: "¿Cuál es la forma de gobierno de España?",
      options: ["República", "Monarquía parlamentaria", "Dictadura", "Anarquía"],
      correctIndex: 1,
    },
    {
      question: "¿En qué año se aprobó la Constitución española vigente?",
      options: ["1975", "1978", "1982", "1992"],
      correctIndex: 1,
    },
    {
      question: "¿Cuál es el principal órgano legislativo en España?",
      options: ["El Senado", "El Congreso de los Diputados", "El Tribunal Constitucional", "El Gobierno"],
      correctIndex: 1,
    },
    {
      question: "¿Qué derecho fundamental protege la Constitución española?",
      options: ["Libertad de expresión", "Derecho a portar armas", "Derecho a la privacidad", "Derecho a la propiedad privada"],
      correctIndex: 0,
    },
  ];
