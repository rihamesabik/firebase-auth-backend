...
const LessonAvancee5: React.FC = () => {
  const questions = [
    {
      question: "¿Cuál es una característica principal de la cultura contemporánea?",
      options: [
        "El rechazo de la tecnología",
        "La globalización y la diversidad cultural",
        "La vuelta al aislamiento cultural",
        "El uso exclusivo de tradiciones antiguas",
      ],
      correctIndex: 1,
    },
    {
      question: "¿Qué movimiento artístico se asocia con la cultura contemporánea?",
      options: [
        "El Renacimiento",
        "El Barroco",
        "El Pop Art",
    ...
    {
      question: "¿Cuál es una influencia importante en la música contemporánea?",
      options: [
        "La música clásica exclusivamente",
        "Las tecnologías digitales y la globalización",
        "Solo la música tradicional",
        "Ninguna influencia externa",
      ],
      correctIndex: 1,
    },
    {
      question: "¿Qué papel juega Internet en la cultura contemporánea?",
      options: [
        "No tiene ningún impacto",
        "Facilita la comunicación y difusión cultural",
        "Limita la expresión artística",
        "Solo es un medio de entretenimiento",
      ],
      correctIndex: 1,
    },
  ];
