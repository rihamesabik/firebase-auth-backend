...
const LessonAvancee6: React.FC = () => {
  const questions = [
    {
      question: "¿Quién fue un famoso pintor español del siglo XX?",
      options: [
        "Leonardo da Vinci",
        "Pablo Picasso",
        "Claude Monet",
    ...
    {
      question: "¿Qué caracteriza al cine de Pedro Almodóvar?",
      options: [
        "Películas mudas",
        "Temas sociales y colores intensos",
    ...
    {
      question: "¿Qué movimiento artístico es conocido por su enfoque en lo irracional y los sueños?",
      options: [
        "Cubismo",
        "Impresionismo",
        "Surrealismo",
    ...
    {
      question: "¿Qué festival internacional de cine se celebra en España?",
      options: [
        "Festival de Cannes",
        "Festival de Berlín",
        "Festival de Venecia",
