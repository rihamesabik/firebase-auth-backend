...
const LessonAvancee7: React.FC = () => {
  const questions = [
    ...
    {
      question: "¿Cuál es una obra famosa de Platón?",
      options: [
        "La Ética a Nicómaco",
        "La República",
        "El Príncipe",
    ...
    {
      question: "¿Qué corriente filosófica afirma que 'el hombre está condenado a ser libre'?",
      options: [
        "Existencialismo",
        "Empirismo",
        "Racionalismo",
    ...
    {
      question: "¿Cuál de estos pensadores es un representante del nihilismo?",
      options: [
        "Karl Marx",
        "Sócrates",
        "Friedrich Nietzsche",
