...
const questions = [
  {
    question: "Comment dit-on 'chemise' en espagnol ?",
    options: ["Zapato", "Sombrero", "Camisa", "Vestido"],
    correctIndex: 2,
  },
  {
    question: "Comment dit-on 'pantalon' en espagnol ?",
    options: ["Camisa", "Pantalón", "Chaqueta", "Gorra"],
    correctIndex: 1,
  },
  {
    question: "Comment dit-on 'chaussure' en espagnol ?",
    options: ["Vestido", "Zapato", "Camisa", "Pantalón"],
    correctIndex: 1,
  },
  {
    question: "Comment dit-on 'robe' en espagnol ?",
    options: ["Vestido", "Zapato", "Sombrero", "Chaqueta"],
    correctIndex: 0,
  },
  {
    question: "Comment dit-on 'manteau' en espagnol ?",
    options: ["Abrigo", "Zapato", "Camisa", "Pantalón"],
    correctIndex: 0,
  },
  {
    question: "Comment dit-on 'chapeau' en espagnol ?",
    options: ["Gorra", "Sombrero", "Vestido", "Camisa"],
    correctIndex: 1,
  },
  {
    question: "Comment dit-on 'veste' en espagnol ?",
    options: ["Chaqueta", "Zapato", "Sombrero", "Pantalón"],
    correctIndex: 0,
  },
];

const LessonDebutant7: React.FC = () => {
...
export default LessonDebutant7;
