...
const questions = [
  {
    question: "Quelle est la différence entre 'subjonctif' et 'indicatif' en français ?",
    options: [
      "Le subjonctif exprime une action incertaine, l’indicatif une action certaine",
      "Le subjonctif est utilisé uniquement au passé",
      "L’indicatif est réservé aux questions seulement",
  ...
  {
    question: "Quelle est la forme correcte du verbe 'venir' au futur simple ?",
    options: ["Viendra", "Vient", "Venait", "Venu"],
    correctIndex: 0,
  },
  {
    question: "Quel est le synonyme de « rapide » ?",
    options: ["Vite", "Lent", "Fort", "Beau"],
    correctIndex: 0,
  },
  {
    question: "Comment traduit-on « malgré » en anglais ?",
    options: ["Despite", "Because", "Although", "However"],
    correctIndex: 0,
  },
  {
    question: "Complétez la phrase : « Il faut que tu ____ venir. »",
    options: ["saches", "sais", "savait", "sauras"],
    correctIndex: 0,
  },
];

const FrancaisLessonAvancee1: React.FC = () => {
    ...
    >
      <div className="w-full max-w-lg bg-white bg-opacity-90 rounded-3xl shadow-2xl p-10 ring-1 ring-purple-300 animate-fadeIn">
        <h1 className="text-4xl font-extrabold mb-10 text-center text-purple-800 drop-shadow-md">
          Leçon de français avancé 1 - Quiz à choix multiples
        </h1>
...
export default FrancaisLessonAvancee1;
