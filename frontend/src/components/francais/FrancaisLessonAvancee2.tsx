...
const questions = [
  {
    question: "Quelle est la forme correcte du participe passé avec l’auxiliaire 'avoir' ?",
    options: [
      "Il a mangé",
      "Il a mangée",
      "Il a manger",
  ...
  },
  {
    ...
    options: ["Cependant", "Parce que", "Donc", "Ainsi"],
    correctIndex: 0,
  },
  {
    question: "Que veut dire l’expression « prendre la poudre d’escampette » ?",
    options: [
      "S’enfuir rapidement",
  ...
  {
    question: "Complétez : « Il faut que tu ______ ton travail avant demain. »",
    options: ["finisses", "finis", "finissait", "finiras"],
    correctIndex: 0,
  },
  {
    question: "Quelle est la bonne conjugaison du verbe 'aller' au conditionnel présent ?",
    options: ["J’irais", "J’allais", "Je vais", "J’irai"],
    correctIndex: 0,
  },
  {
    question: "Quel mot est un antonyme de « visible » ?",
    options: ["Invisible", "Clair", "Brillant", "Lumineux"],
    correctIndex: 0,
  },
  {
    question: "Que signifie l’expression « être au bout du rouleau » ?",
    options: [
      "Être très fatigué",
      "Être heureux",
      "Être en colère",
...
const FrancaisLessonAvancee2: React.FC = () => {
    ...
    >
      <div className="w-full max-w-lg bg-white bg-opacity-90 rounded-3xl shadow-2xl p-10 ring-1 ring-purple-300 animate-fadeIn">
        <h1 className="text-4xl font-extrabold mb-10 text-center text-purple-800 drop-shadow-md">
          Leçon de français avancé 2 - Quiz à choix multiples
        </h1>
...
export default FrancaisLessonAvancee2;
