...
const questions = [
  {
    question: "Quelle est la fonction grammaticale du mot 'qui' dans cette phrase : « La femme qui parle est gentille. » ?",
    options: ["Pronom relatif", "Adverbe", "Verbe", "Adjectif"],
    correctIndex: 0,
  },
  {
    question: "Quel temps utilise-t-on pour parler d’une action antérieure à une autre action passée ?",
    options: ["Plus-que-parfait", "Imparfait", "Passé simple", "Futur antérieur"],
    correctIndex: 0,
  },
  {
    question: "Dans la phrase « Il faut que tu sois prêt », quel mode est utilisé ?",
    options: ["Subjonctif", "Indicatif", "Conditionnel", "Impératif"],
    correctIndex: 0,
  },
  {
    question: "Quelle est la forme négative correcte ?",
    options: [
      "Je ne sais pas",
      "Je sais pas",
      "Je ne sais",
  ...
  },
  {
    ...
    options: [
      ...
      "Il disait qu’il venait demain.",
      "Il venait demain.",
    ],
    correctIndex: 0,
  },
  {
    question: "Quel est le féminin de « écrivain » ?",
    options: ["écrivaine", "écrivainne", "écrivainne", "écrivainee"],
    correctIndex: 0,
  },
  {
...
const FrancaisLessonAvancee4: React.FC = () => {
    ...
    >
      <div className="w-full max-w-lg bg-white bg-opacity-90 rounded-3xl shadow-2xl p-10 ring-1 ring-purple-300 animate-fadeIn">
        <h1 className="text-4xl font-extrabold mb-10 text-center text-purple-800 drop-shadow-md">
          Leçon de français avancé 4 - Quiz à choix multiples
        </h1>
...
export default FrancaisLessonAvancee4;
