...
const FrancaisLessonDebutant4: React.FC = () => {
  const questions = [
    {
      question: "ماذا يعني 'أب' بالفرنسية؟",
      options: ["Mère", "Frère", "Père", "Oncle"],
      correctIndex: 2,
    },
    {
      question: "ماذا يعني 'أم' بالفرنسية؟",
      options: ["Tante", "Mère", "Cousin", "Sœur"],
      correctIndex: 1,
    },
    {
      question: "ماذا يعني 'أخ' بالفرنسية؟",
      options: ["Sœur", "Frère", "Oncle", "Père"],
      correctIndex: 1,
    },
    {
      question: "ماذا يعني 'أخت' بالفرنسية؟",
      options: ["Mère", "Cousin", "Sœur", "Grand-mère"],
      correctIndex: 2,
    },
    {
      question: "ماذا يعني 'عم' بالفرنسية؟",
      options: ["Oncle", "Neveu", "Père", "Beau-frère"],
      correctIndex: 0,
    },
    {
      question: "ماذا يعني 'عمة' بالفرنسية؟",
      options: ["Grand-mère", "Mère", "Tante", "Sœur"],
      correctIndex: 2,
    },
    {
      question: "ماذا يعني 'ابن عم' بالفرنسية؟",
      options: ["Frère", "Cousin", "Oncle", "Neveu"],
      correctIndex: 1,
    },
  ];
    ...
    <div className="min-h-screen flex flex-col items-center justify-center bg-gradient-to-r from-indigo-200 via-purple-300 to-pink-200 p-6 font-sans">
      <div className="w-full max-w-lg bg-white bg-opacity-90 rounded-3xl shadow-2xl p-10 ring-1 ring-purple-300 animate-fadeIn">
        <h1 className="text-4xl font-extrabold mb-10 text-center text-purple-800 drop-shadow-md">
          درس الفرنسية للمبتدئين 4 - أفراد العائلة
        </h1>
...
export default FrancaisLessonDebutant4;
