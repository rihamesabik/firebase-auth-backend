...
const FrancaisLessonDebutant6: React.FC = () => {
  const questions = [
    {
      question: "Que signifie 'Un' en anglais ?",
      options: ["One", "Two", "Three", "Four"],
      correctIndex: 0,
    },
    {
      question: "Que signifie 'Deux' en anglais ?",
      options: ["One", "Two", "Three", "Five"],
      correctIndex: 1,
    },
    {
      question: "Que signifie 'Trois' en anglais ?",
      options: ["Three", "Four", "Five", "Six"],
      correctIndex: 0,
    },
    {
      question: "Que signifie 'Quatre' en anglais ?",
      options: ["Two", "Four", "Six", "Seven"],
      correctIndex: 1,
    },
    {
      question: "Que signifie 'Cinq' en anglais ?",
      options: ["Five", "Seven", "Eight", "Nine"],
      correctIndex: 0,
    },
    {
      question: "Que signifie 'Six' en anglais ?",
      options: ["Six", "Eight", "Ten", "Eleven"],
      correctIndex: 0,
    },
    {
      question: "Que signifie 'Sept' en anglais ?",
      options: ["Seven", "Six", "Nine", "Ten"],
      correctIndex: 0,
    },
  ];
    ...
    <div className="min-h-screen flex flex-col items-center justify-center bg-gradient-to-r from-indigo-200 via-purple-300 to-pink-200 p-6 font-sans">
      <div className="w-full max-w-lg bg-white bg-opacity-90 rounded-3xl shadow-2xl p-10 ring-1 ring-purple-300 animate-fadeIn">
        <h1 className="text-4xl font-extrabold mb-10 text-center text-purple-800 drop-shadow-md">
          Leçon 6 : Les chiffres en anglais
        </h1>
...
export default FrancaisLessonDebutant6;
