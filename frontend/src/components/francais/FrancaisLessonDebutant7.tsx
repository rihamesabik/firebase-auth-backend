...
const FrancaisLessonDebutant7: React.FC = () => {
  const questions = [
    {
      question: "ماذا يعني 'قميص'؟",
      options: ["Pantalon", "Chemise", "Chapeau", "Chaussure"],
      correctIndex: 1,
    },
    {
      question: "ماذا يعني 'بنطلون'؟",
      options: ["Veste", "Pantalon", "Chemise", "Gants"],
      correctIndex: 1,
    },
    {
      question: "ماذا يعني 'أحذية'؟",
      options: ["Chaussures", "Chaussettes", "Chapeau", "Écharpe"],
      correctIndex: 0,
    },
    {
      question: "ماذا يعني 'قبعة'؟",
      options: ["Chapeau", "Gants", "Chemise", "Pantalon"],
      correctIndex: 0,
    },
    {
      question: "ماذا يعني 'وشاح'؟",
      options: ["Écharpe", "Chemise", "Chaussettes", "Veste"],
      correctIndex: 0,
    },
    {
      question: "ماذا يعني 'قفازات'؟",
      options: ["Gants", "Chaussures", "Chapeau", "Pantalon"],
      correctIndex: 0,
    },
    {
      question: "ماذا يعني 'سترة'؟",
      options: ["Veste", "Chemise", "Pantalon", "Chapeau"],
      correctIndex: 0,
    },
  ];
...
export default FrancaisLessonDebutant7;
