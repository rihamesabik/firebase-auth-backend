...
const questions = [
  {
    question: "ما هو الفعل المناسب لإكمال الجملة: 'Je ___ au travail à 8h' ؟",
    options: ["vais", "va", "aller", "allez"],
    correctIndex: 0,
  },
  {
    question: "اختر الكلمة التي تعبر عن الشعور بالحزن:",
    options: ["heureux", "content", "triste", "souriant"],
    correctIndex: 2,
  },
  {
    question: "ما هو اسم الفاعل من الفعل 'parler'؟",
    options: ["parlé", "parlant", "parleur", "parlée"],
    correctIndex: 1,
  },
  {
    question: "اختر الجملة الصحيحة من حيث التوافق بين الفاعل والفعل:",
    options: [
      "Tu sommes fatigué",
      "Ils est contents",
      "Nous avons fini",
  ...
  {
    question: "ما هو معنى العبارة 'il pleut des cordes'؟",
    options: [
      "إنه يمطر قليلًا",
      "الطقس مشمس",
      "إنها تمطر بغزارة",
  ...
  {
    question: "أي من هذه الكلمات تعتبر صفة؟",
    options: ["rapidement", "intelligent", "manger", "bleuement"],
    correctIndex: 1,
  },
  {
...
const FrancaisLessonIntermediaire3: React.FC = () => {
    ...
    >
      <div className="w-full max-w-lg bg-white bg-opacity-90 rounded-3xl shadow-2xl p-10 ring-1 ring-purple-300 animate-fadeIn">
        <h1 className="text-4xl font-extrabold mb-10 text-center text-purple-800 drop-shadow-md">
          درس الفرنسية المستوى المتوسط 3 - اختبار متعدد الخيارات
        </h1>
...
export default FrancaisLessonIntermediaire3;
