...
const questions = [
  {
    question: "Quelle est la traduction de 'chien' en français ?",
    options: ["Chat", "Chien", "Oiseau", "Poisson"],
    correctIndex: 1,
  },
  {
    question: "Comment dit-on 'to eat' en français ?",
    options: ["Boire", "Manger", "Dormir", "Parler"],
    correctIndex: 1,
  },
  {
    question: "Que signifie 'bibliothèque' ?",
  ...
  {
    question: "Comment dit-on 'yesterday' en français ?",
    ...
    >
      <div className="w-full max-w-lg bg-white bg-opacity-90 rounded-3xl shadow-2xl p-10 ring-1 ring-purple-300 animate-fadeIn">
        <h1 className="text-4xl font-extrabold mb-10 text-center text-purple-800 drop-shadow-md">
          درس الفرنسية المستوى المتوسط 5 - اختبار متعدد الخيارات
        </h1>
