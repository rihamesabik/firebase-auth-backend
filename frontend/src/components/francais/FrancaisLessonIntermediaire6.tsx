...
const questions = [
  {
    question: "Comment dit-on 'liberté' en français ?",  // Freedom = liberté
    options: ["Liberté", "Justice", "Paix", "Pouvoir"],
    correctIndex: 0,
  },
  {
    question: "Quel est le synonyme de 'rapide' ?",  // Fast = rapide
    options: ["Lent", "Vite", "Fort", "Doux"],
    correctIndex: 1,
  },
  {
    question: "Quelle est la traduction de 'chanson' ?",  // Song = chanson
    options: ["Livre", "Chanson", "Danse", "Film"],
    correctIndex: 1,
  },
  {
    question: "Comment dit-on 'espoir' en français ?",  // Hope = espoir
    options: ["Tristesse", "Espoir", "Colère", "Joie"],
    correctIndex: 1,
  },
  {
    question: "Quel mot signifie 'amitié' ?",  // Friendship = amitié
    options: ["Amour", "Amitié", "Peur", "Haïr"],
    correctIndex: 1,
  },
  {
    question: "Quelle est la signification de 'lumière' ?",  // Light = lumière
    options: ["Lumière", "Ombre", "Froid", "Chaleur"],
    correctIndex: 0,
  },
  {
    question: "Comment dit-on 'vérité' en français ?",  // Truth = vérité
    options: ["Mensonge", "Rêve", "Vérité", "Espoir"],
    correctIndex: 2,
  },
];

const FrancaisLessonIntermediaire6: React.FC = () => {
    ...
    >
      <div className="w-full max-w-lg bg-white bg-opacity-90 rounded-3xl shadow-2xl p-10 ring-1 ring-purple-300 animate-fadeIn">
        <h1 className="text-4xl font-extrabold mb-10 text-center text-purple-800 drop-shadow-md">
          درس الفرنسية المستوى المتوسط 6 - اختبار متعدد الخيارات
        </h1>
...
export default FrancaisLessonIntermediaire6;
