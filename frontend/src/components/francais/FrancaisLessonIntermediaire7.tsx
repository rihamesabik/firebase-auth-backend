...
const questions = [
  {
    question: "Que signifie 'avenir' en français ?", // Future = avenir
    options: ["Passé", "Présent", "Avenir", "Hier"],
    correctIndex: 2,
  },
  {
    question: "Quel est le contraire de 'facile' ?", // Difficult = difficile
    options: ["Simple", "Difficile", "Léger", "Rapide"],
    correctIndex: 1,
  },
  {
    question: "Comment dit-on 'pouvoir' en français ?", // Power = pouvoir
    options: ["Force", "Pouvoir", "Faiblesse", "Courage"],
    correctIndex: 1,
  },
  {
    question: "Quel mot correspond à 'joie' ?", // Joy = joie
    options: ["Tristesse", "Joie", "Colère", "Peur"],
    correctIndex: 1,
  },
  {
    question: "Quelle est la traduction de 'étoile' ?", // Star = étoile
    options: ["Lune", "Soleil", "Étoile", "Planète"],
    correctIndex: 2,
  },
  {
    question: "Que signifie 'santé' en français ?", // Health = santé
    options: ["Maladie", "Santé", "Douleur", "Fatigue"],
    correctIndex: 1,
  },
  {
    question: "Comment dit-on 'rêve' en français ?", // Dream = rêve
    options: ["Cauchemar", "Rêve", "Souvenir", "Pensée"],
    correctIndex: 1,
  },
];

const FrancaisLessonIntermediaire7: React.FC = () => {
    ...
    >
      <div className="w-full max-w-lg bg-white bg-opacity-90 rounded-3xl shadow-2xl p-10 ring-1 ring-purple-300 animate-fadeIn">
        <h1 className="text-4xl font-extrabold mb-10 text-center text-purple-800 drop-shadow-md">
          درس الفرنسية المستوى المتوسط 7 - اختبار متعدد الخيارات
        </h1>
...
export default FrancaisLessonIntermediaire7;
