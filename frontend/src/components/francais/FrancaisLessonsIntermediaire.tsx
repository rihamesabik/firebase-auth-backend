...
const FrancaisLessonsIntermediaire: React.FC = () => {
  ...
  const lessons = [
    { id: 1, title: "Leçon 1 : Les verbes courants" },
    { id: 2, title: "Leçon 2 : Les prépositions de lieu" },
    { id: 3, title: "Leçon 3 : Les temps du passé" },
    { id: 4, title: "Leçon 4 : Les adjectifs qualificatifs" },
    { id: 5, title: "Leçon 5 : Les phrases interrogatives" },
    { id: 6, title: "Leçon 6 : Les expressions idiomatiques" },
    { id: 7, title: "Leçon 7 : Les prépositions des temps" },
  ];

  const lessonPath = (id: number) => `/francais/intermediaire/lesson-${id}`;
